...
**Проблема:** train-time scaling упирается в потолок — стоимость обучения растёт суперлинейно, а returns diminishing. GPT-4 стоил ~$100M, следующее поколение может стоить $1B+.
...
**Train-time:** $100M на обучение GPT-4, и эта модель одинаково обрабатывает и «2+2» и «докажи теорему».
