...
*LoRA: вместо обновления полной матрицы $W$ обучаются только низкоранговые матрицы $A$ и $B$, которые при инференсе сливаются с оригинальными весами (источник: Hu et al., [LoRA](https://arxiv.org/abs/2106.09685), Figure 1)*
