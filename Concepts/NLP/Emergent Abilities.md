...
> [!todo] Редакционный пробел
> Для этой legacy-заметки не подобрана готовая иллюстрация, которая одновременно
> показывает исходный аргумент Wei et al. и возражение Schaeffer et al. До
> такого сравнения заметка не возвращается в читательскую навигацию. Исходные
> графики находятся в [Wei et al., Figures 2–4](https://arxiv.org/pdf/2206.07682)
> и [Schaeffer et al., Figures 1–3](https://arxiv.org/pdf/2304.15004).
