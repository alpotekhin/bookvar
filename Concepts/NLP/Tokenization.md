...
*Полный конвейер токенизатора: нормализация и предварительное разбиение
предшествуют собственно модели токенизации, после чего добавляются специальные
токены и собирается итоговая кодировка. Готовая схема из
[Hugging Face Course, The tokenization pipeline](https://huggingface.co/docs/course/main/chapter6/4),
лицензия Apache 2.0. Пошаговое обучение BPE разобрано ниже на примере из того же
курса.*
