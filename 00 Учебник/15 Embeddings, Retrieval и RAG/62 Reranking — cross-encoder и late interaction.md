...
Retriever сокращает миллион документов до сотен кандидатов, но независимые
...
слоях, а classification head выдаёт score релевантности:
...
Высокий score cross-encoder не обязательно является вероятностью
...
Reranker оценивают только при фиксированной candidate set. Иначе улучшение
