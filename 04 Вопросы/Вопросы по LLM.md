...
- Почему benchmark score нельзя интерпретировать без prompt, decoding protocol,
  uncertainty и проверки contamination? → [[02 Areas/ML & DL/00 Учебник/18 Evaluation и методология/59 Оценивание моделей и контаминация#Протокол является частью набора испытаний|Протокол benchmark]]
