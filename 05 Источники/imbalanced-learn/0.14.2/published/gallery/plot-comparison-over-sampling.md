---
title: "Compare over-sampling samplers"
...
source_sha256: 6d1d251269ff290af942f7584840cebdb7c7e5d555d7c6de520280380867a801
license: MIT
---

> [!note] Pinned original source
> This readable page was generated from the complete upstream file
> [`examples/over-sampling/plot_comparison_over_sampling.py`](https://github.com/scikit-learn-contrib/imbalanced-learn/blob/8504e95f0160f61d1b617ca66f779646d2ee609e/examples/over-sampling/plot_comparison_over_sampling.py) at commit
...
> `6d1d251269ff290af942f7584840cebdb7c7e5d555d7c6de520280380867a801`. The project is distributed under the
...
class. The class `RandomOverSampler`
...
`ADASYN` and
`SMOTE` can be used in this case.
...
`ADASYN` and
`SMOTE`.
`ADASYN` will focus on the samples which are
...
`SMOTENC` is the only method which can handle
this case.
