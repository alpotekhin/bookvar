---
title: "Fitting model on imbalanced datasets and how to fight bias"
...
source_sha256: 9741399615f4216de0d472c87e43e57806f7f92a57e563fa285e1d7dd04ee1d4
license: MIT
---

> [!note] Pinned original source
> This readable page was generated from the complete upstream file
> [`examples/applications/plot_impact_imbalanced_classes.py`](https://github.com/scikit-learn-contrib/imbalanced-learn/blob/8504e95f0160f61d1b617ca66f779646d2ee609e/examples/applications/plot_impact_imbalanced_classes.py) at commit
...
> `9741399615f4216de0d472c87e43e57806f7f92a57e563fa285e1d7dd04ee1d4`. The project is distributed under the
...
`LogisticRegression` classifier. In this regard,
...
`LogisticRegression`. We can then evaluate our
model.
...
such as `RandomForestClassifier`. With this type of
...
The `RandomForestClassifier` is as well affected by
...
the `RandomForestClassifier` is still biased toward
...
`BalancedRandomForestClassifier` is better than
