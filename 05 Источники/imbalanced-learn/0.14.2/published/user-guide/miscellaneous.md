...
source_sha256: bf17eca6ce63abb920df3dbfae339c8d9c24a9cb06207ae3caad6643534ad123
license: MIT
---

> [!note] Pinned original source
> This readable page was generated from the complete upstream file
> [`doc/miscellaneous.rst`](https://github.com/scikit-learn-contrib/imbalanced-learn/blob/8504e95f0160f61d1b617ca66f779646d2ee609e/doc/miscellaneous.rst) at commit
...
> `bf17eca6ce63abb920df3dbfae339c8d9c24a9cb06207ae3caad6643534ad123`. The project is distributed under the
...
A fully customized sampler, `FunctionSampler`, is available in
...
`Pipeline`:
[`sphx_glr_auto_examples_applications_plot_outlier_rejections.py`](https://imbalanced-learn.org/stable/)
...
The `balanced_batch_generator` allows to generate
...
`balanced_batch_generator` creates a balanced
...
`BalancedBatchGenerator`. Only an instance of this class
...
> [!note] References
> - [`sphx_glr_auto_examples_applications_porto_seguro_keras_under_sampling.py`](https://imbalanced-learn.org/stable/)
