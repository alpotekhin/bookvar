---
title: "TinyTorch 10_tokenization: Tokenization"
...
> [`tinytorch/src/10_tokenization/10_tokenization.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/10_tokenization/10_tokenization.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/10_tokenization/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Tokenization
subtitle: Converting Text to Numbers
description: Build tokenization systems that convert text to numerical representations.
````
