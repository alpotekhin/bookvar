---
title: "TinyTorch 15_quantization: Quantization"
...
> [`tinytorch/src/15_quantization/15_quantization.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/15_quantization/15_quantization.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/15_quantization/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Quantization
subtitle: Reduced Precision for Efficiency
description: Reduce model precision from FP32 to INT8 while preserving accuracy.
````
