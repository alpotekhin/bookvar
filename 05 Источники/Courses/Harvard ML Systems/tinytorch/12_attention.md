---
title: "TinyTorch 12_attention: Attention"
...
> [`tinytorch/src/12_attention/12_attention.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/12_attention/12_attention.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/12_attention/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Attention
subtitle: Learning to Focus
description: Build scaled dot-product and multi-head attention mechanisms.
````
