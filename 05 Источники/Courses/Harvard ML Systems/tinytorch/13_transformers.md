---
title: "TinyTorch 13_transformers: Transformers"
...
> [`tinytorch/src/13_transformers/13_transformers.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/13_transformers/13_transformers.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/13_transformers/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Transformers
subtitle: Complete Transformer Architecture
description: Build TransformerBlock, GPT architecture, and autoregressive generation.
````
