---
title: "TinyTorch 02_activations: Activations"
...
> [`tinytorch/src/02_activations/02_activations.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/02_activations/02_activations.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/02_activations/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Activations
subtitle: Intelligence Through Nonlinearity
description: Add the secret ingredient that makes neural networks intelligent - nonlinearity.
````
