---
title: "TinyTorch 11_embeddings: Embeddings"
...
> [`tinytorch/src/11_embeddings/11_embeddings.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/11_embeddings/11_embeddings.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/11_embeddings/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
> Software is licensed under [MIT](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/LICENSE);
> educational prose embedded in the module is licensed under
> [CC BY-NC-SA 4.0](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/LICENSE.md).
...
````yaml
title: Embeddings
subtitle: Converting Tokens to Learnable Representations
description: Build embedding layers that convert tokens into dense, learnable vectors.
````
