---
title: "TinyTorch 19_benchmarking: Benchmarking"
...
> [`tinytorch/src/19_benchmarking/19_benchmarking.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/19_benchmarking/19_benchmarking.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/19_benchmarking/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Benchmarking
subtitle: TorchPerf Olympics Preparation
description: Build the benchmarking infrastructure for the capstone competition.
````
