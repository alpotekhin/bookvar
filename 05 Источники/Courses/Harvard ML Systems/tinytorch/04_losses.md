---
title: "TinyTorch 04_losses: Losses"
...
> [`tinytorch/src/04_losses/04_losses.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/04_losses/04_losses.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/04_losses/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Losses
subtitle: Measuring How Wrong We Are
description: Implement loss functions that measure prediction quality for training.
````
