---
title: "TinyTorch 08_training: Training"
...
> [`tinytorch/src/08_training/08_training.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/08_training/08_training.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/08_training/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Training
subtitle: Complete Learning Loops
description: Build complete training loops with checkpointing and scheduling.
````
