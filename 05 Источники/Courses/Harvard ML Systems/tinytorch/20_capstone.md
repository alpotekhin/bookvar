---
title: "TinyTorch 20_capstone: Capstone"
...
> [`tinytorch/src/20_capstone/20_capstone.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/20_capstone/20_capstone.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/20_capstone/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Capstone
subtitle: Benchmarking & Submission
description: Demonstrate your framework with benchmarks and generate a submission.
````
