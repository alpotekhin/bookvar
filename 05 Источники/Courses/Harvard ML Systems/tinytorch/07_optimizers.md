---
title: "TinyTorch 07_optimizers: Optimizers"
...
> [`tinytorch/src/07_optimizers/07_optimizers.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/07_optimizers/07_optimizers.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/07_optimizers/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Optimizers
subtitle: Sophisticated Learning Algorithms
description: Build SGD, Adam, and AdamW optimizers for neural network training.
````
