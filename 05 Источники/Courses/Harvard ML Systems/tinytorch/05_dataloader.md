---
title: "TinyTorch 05_dataloader: DataLoader"
...
> [`tinytorch/src/05_dataloader/05_dataloader.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/05_dataloader/05_dataloader.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/05_dataloader/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: DataLoader
subtitle: Efficient Data Pipeline
description: Build data loading infrastructure for efficient ML training.
````
