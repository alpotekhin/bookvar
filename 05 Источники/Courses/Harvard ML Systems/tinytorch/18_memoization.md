---
title: "TinyTorch 18_memoization: Memoization"
...
> [`tinytorch/src/18_memoization/18_memoization.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/18_memoization/18_memoization.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/18_memoization/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Memoization
subtitle: Computational Reuse for Inference
description: Implement KV caching for 10-15x faster transformer text generation.
````
