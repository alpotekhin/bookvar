---
title: "TinyTorch 06_autograd: Autograd"
...
> [`tinytorch/src/06_autograd/06_autograd.py`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/06_autograd/06_autograd.py) and its
> [`module.yaml`](https://github.com/harvard-edge/cs249r_book/blob/2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd/tinytorch/src/06_autograd/module.yaml) from commit `2bd97c509923dc8d7cb0b3e2f489a7282fee5fbd`.
...
````yaml
title: Autograd
subtitle: The Gradient Engine
description: Build the autograd system that computes gradients automatically.
````
