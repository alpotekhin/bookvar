...
> [`chapter_recommender-systems/seqrec.md`](https://github.com/d2l-ai/d2l-en/blob/23d7a5aecceee57d1292c56e90cce307f183bb0a/chapter_recommender-systems/seqrec.md) from *Dive into Deep Learning* at commit
...
* Apart from the sequence-aware recommendation task we introduced above, there is another type of sequence-aware recommendation task called session-based recommendation [Hidasi.Karatzoglou.Baltrunas.ea.2015](https://github.com/d2l-ai/d2l-en/blob/23d7a5aecceee57d1292c56e90cce307f183bb0a/d2l.bib). Can you explain the differences between these two tasks?
