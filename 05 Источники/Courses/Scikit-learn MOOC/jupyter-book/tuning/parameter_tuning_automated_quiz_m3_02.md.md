...
> This page preserves [`jupyter-book/tuning/parameter_tuning_automated_quiz_m3_02.md`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/jupyter-book/tuning/parameter_tuning_automated_quiz_m3_02.md) from the
...
`> [!note] Question
> Given `pipeline` defined by:python
...
> [!note] We **transformed most axis values by taking a log10 or log2** to
