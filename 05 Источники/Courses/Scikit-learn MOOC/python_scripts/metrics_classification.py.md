...
> This page preserves [`python_scripts/metrics_classification.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/metrics_classification.py) from the
...
> [!tip] Scikit-learn will return a display containing all plotting element. Notably,
