---
title: "Evaluation and hyperparameter tuning"
...
> This page preserves [`python_scripts/parameter_tuning_nested.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/parameter_tuning_nested.py) from the
...
> [!note] This figure shows the particular case of **K-fold** cross-validation
...
> [!note] This figure illustrates the nested cross-validation strategy using
