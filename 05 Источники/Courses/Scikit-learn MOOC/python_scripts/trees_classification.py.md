---
title: "Build a classification decision tree"
...
> This page preserves [`python_scripts/trees_classification.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/trees_classification.py) from the
...
> [!tip] We are using the function `fig, ax = plt.subplots(figsize=(8, 6))` to create
