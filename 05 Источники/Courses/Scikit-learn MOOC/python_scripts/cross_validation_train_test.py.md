...
> This page preserves [`python_scripts/cross_validation_train_test.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/cross_validation_train_test.py) from the
...
> [!note] In this MOOC, we will consistently use the term "training error".
...
> [!note] In this MOOC, we will consistently use the term "testing error".
...
![[Assets/Sources/Scikit-learn MOOC/figures/shufflesplit_diagram.png|Cross-validation diagram]]

> [!note] This figure shows the particular case of **shuffle-split** cross-validation
...
> [!tip] A score is a metric for which higher values mean better results. On the
