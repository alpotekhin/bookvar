---
title: "Hyperparameter tuning by randomized-search"
...
> This page preserves [`python_scripts/parameter_tuning_randomized_search.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/parameter_tuning_randomized_search.py) from the
...
![[Assets/Sources/Scikit-learn MOOC/figures/grid_vs_random_search.svg|Randomized vs grid search]]
...
> [!note] Random search (with `RandomizedSearchCV`) is typically beneficial compared to
...
> [!note] `scipy.stats.loguniform` can be used to generate floating numbers. To generate
