...
> This page preserves [`python_scripts/parameter_tuning_manual.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/parameter_tuning_manual.py) from the
...
> [!note] For more information on the model hyperparameter `C`, refer to the
...
> [!warning] When we evaluate a family of models on test data and pick the best performer,
