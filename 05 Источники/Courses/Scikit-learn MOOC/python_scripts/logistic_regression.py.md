...
> This page preserves [`python_scripts/logistic_regression.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/logistic_regression.py) from the
...
> [!note] Here, we use the class `DecisionBoundaryDisplay`. This educational tool allows
...
> [!warning] We insist that the output of `predict_proba` are just estimations. Their
