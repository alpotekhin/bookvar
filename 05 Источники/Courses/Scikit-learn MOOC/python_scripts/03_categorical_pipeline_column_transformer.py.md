...
> This page preserves [`python_scripts/03_categorical_pipeline_column_transformer.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/03_categorical_pipeline_column_transformer.py) from the
...
> [!warning] Here, we know that `object` data type is used to represent strings and thus
...
![[Assets/Sources/Scikit-learn MOOC/figures/api_diagram-columntransformer.svg|columntransformer diagram]]
...
> [!warning] Be aware that we use `train_test_split` here for didactic purposes, to show
