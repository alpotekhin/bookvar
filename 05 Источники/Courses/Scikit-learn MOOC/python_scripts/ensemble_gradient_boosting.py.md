...
> This page preserves [`python_scripts/ensemble_gradient_boosting.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/ensemble_gradient_boosting.py) from the
...
> [!tip] In the cell above, we manually edited the legend to get only a single label
