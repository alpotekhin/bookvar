---
title: "Non-linear feature engineering for Logistic Regression"
...
> This page preserves [`python_scripts/linear_models_feature_engineering_classification.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/linear_models_feature_engineering_classification.py) from the
...
> [!note] Notice that `KBinsDiscretizer(encode="onehot")` and `SplineTransformer` do not
