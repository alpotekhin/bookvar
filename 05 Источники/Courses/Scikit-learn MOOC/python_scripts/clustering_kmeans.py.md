...
> This page preserves [`python_scripts/clustering_kmeans.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/clustering_kmeans.py) from the
...
> [!tip] Here we used the `fit_predict` method, which does both steps at once: it
