---
title: "Non-linear feature engineering for Linear Regression"
...
> This page preserves [`python_scripts/linear_regression_non_linear_link.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/linear_regression_non_linear_link.py) from the
...
> [!tip] `np.random.RandomState` allows creating a random number generator which can
...
> [!warning] In scikit-learn, by convention `data` (also called `X` in the scikit-learn
