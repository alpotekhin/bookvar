---
title: "First look at our dataset"
...
> This page preserves [`python_scripts/01_tabular_data_exploration.py`](https://github.com/INRIA/scikit-learn-mooc/blob/0cc70c41c640578c28eb7fd38d8c1c19e09c8aa6/python_scripts/01_tabular_data_exploration.py) from the
...
> [!note] [Pandas](https://pandas.pydata.org/) is a Python library used for
...
> [!note] Here, classes are slightly imbalanced, meaning there are more samples of one
...
> [!tip] In the previous cell, we used the following pattern: `_ = func()`. We do this
...
> [!note] In the upcoming notebooks, we will only keep the `"education"` variable,
