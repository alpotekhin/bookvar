---
title: "Building a Memory-Enhanced Email Agent with LangGraph"
...
> This page preserves [`all_agents_tutorials/memory-agent-tutorial.ipynb`](https://github.com/NirDiamant/GenAI_Agents/blob/bd681451b254ac1a790e947b581d3997ab35013d/all_agents_tutorials/memory-agent-tutorial.ipynb) from
...
![[Assets/Sources/GenAI Agents/all_agents_tutorials/memory-agent-tutorial/cell-023-output-01.png]]
...
![](https://europe-west1-genai-agents-views-tracker.cloudfunctions.net/genai-agents-tracker?notebook=all-agents-tutorials--memory-agent-tutorial)
