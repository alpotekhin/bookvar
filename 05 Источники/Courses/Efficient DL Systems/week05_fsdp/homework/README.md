...
> [`week05_fsdp/homework/README.md`](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week05_fsdp/homework/README.md) in *Efficient Deep Learning Systems* at commit
...
- Overlap can be verified using profiling traces. To visualize them use
  [perfetto.dev](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week05_fsdp/homework/perfetto.dev). `train.py` saves profiling traces to
  `traces/(effdl|fsdp2)`.
- Memory snapshots can be visualized using
  [pytorch.org/memory_viz](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week05_fsdp/homework/pytorch.org/memory_viz). `train.py` saves memory
