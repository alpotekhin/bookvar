...
> [`week03_data_parallel/homework/README.md`](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week03_data_parallel/homework/README.md) in *Efficient Deep Learning Systems* at commit
...
Implement deterministic sequential printing with **two orders per iteration**:
first ascending (0..N-1), then descending (N-1..0).
Use only point-to-point communication (`send`/`recv`) and **no** collectives
(including `barrier`). Use [sequential_print.py](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week03_data_parallel/homework/sequential_print.py) as a template.
...
This test needs to be implemented via `pytest` in [test_syncbn.py](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week03_data_parallel/homework/test_syncbn.py): in particular, all the above 
...
Use [syncbn.py](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week03_data_parallel/homework/syncbn.py) and [ddp_cifar100.py](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week03_data_parallel/homework/ddp_cifar100.py) as a template. 
...
Using [allreduce.py](https://github.com/mryab/efficient-dl-systems/blob/e632aa89ca9e6638d52e1b686095e7442faffbb0/week03_data_parallel/homework/allreduce.py) as a template, implement the Ring All-Reduce algorithm
