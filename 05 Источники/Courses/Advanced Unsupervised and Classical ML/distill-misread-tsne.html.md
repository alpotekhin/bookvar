...
> Imported reproducibly from [`distill-misread-tsne.html`](https://distill.pub/2016/misread-tsne/). License: CC BY 2.0.
> Upstream repository: [https://github.com/distillpub/post--misread-tsne](https://github.com/distillpub/post--misread-tsne); pinned
> revision: [`f2492b469bec8aaa7aa83cc828081e14a295414d`](https://github.com/distillpub/post--misread-tsne/commit/f2492b469bec8aaa7aa83cc828081e14a295414d).
...
We are grateful to Chris Olah and Shan Carter for creating this platform, and for excellent design and editorial
...
[tsnejs](https://github.com/karpathy/tsnejs) library used in the interactive diagrams.
...
[View all changes](https://github.com/distillpub/post--misread-tsne/compare/de6941fa8fc6c4db9d8e4b4f4d7f604817db562c...f2492b469bec8aaa7aa83cc828081e14a295414d) to this article since it was first published. If you see a mistake or want to suggest a change, please [create an issue on GitHub](https://github.com/distillpub/post--misread-tsne/issues/new).

### Citations and Reuse

Diagrams and text are licensed under Creative Commons Attribution [CC-BY 2.0](https://creativecommons.org/licenses/by/2.0/), unless noted otherwise, with the [source available on GitHub](https://github.com/distillpub/post--misread-tsne). The figures that have been reused from other sources don't fall under this license and can be recognized by a note in their caption: “Figure from …”.
...
[About](http://distill.pub/about/)
[Submit](http://distill.pub/journal/)
[Prize](http://distill.pub/prize/)
[Archive](http://distill.pub/archive/)
